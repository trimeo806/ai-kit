...
Executes inline in main context — the main context dispatches muji via custom agent dispatch.
...
4. Delegate to muji via custom agent dispatch with:
...
7. Dispatch muji via custom agent dispatch with confirmed findings:
