...
Add to your `.codex/config.toml and .codex/hooks.json` or `.codex/config.toml and .codex/hooks.json`:
...
- Verify hooks are added to `.codex/config.toml and .codex/hooks.json`
