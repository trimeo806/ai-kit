...
| _(auto-detect)_ | Dispatch to debugger via OpenCode subagent dispatch | debugger handles general debugging |
...
**Dispatch to debugger via OpenCode subagent dispatch** with the full issue context before proceeding. debugger will handle detection, investigation, and fixing. The modes below are instructions for debugger.
