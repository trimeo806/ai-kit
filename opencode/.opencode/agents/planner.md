...
**IMPORTANT**: Analyze skills at `.agents/skills/*` and activate skills needed during the task.
...
- `.agents/skills/plan/SKILL.md` — Planning workflow, expertise, templates
- `.agents/skills/subagent-driven-development/SKILL.md` — Researcher/architect dispatch patterns
- `.agents/skills/knowledge-retrieval/SKILL.md` — Internal-first search protocol
