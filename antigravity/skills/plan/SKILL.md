...
| Action | Command |
|--------|---------|
| Activate | Update `plan.md` status to `active` |
| Complete | Update `plan.md` status to `completed` |
| Archive | Update `plan.md` status to `archived` |
...
Before generating any phase file, scan `_agents/workflows/` and `skills/skill-index.json`.
